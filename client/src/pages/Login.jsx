        ...
        <div style={{ minHeight: "100vh", display: "flex", fontFamily: "Inter, sans-serif", background: "#08080f" }}>
            ...
            >
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                    ...
                    <p style={{ fontSize: 16, color: "#6b7280", lineHeight: 1.7, maxWidth: 340, margin: "0 0 48px" }}>
                        AI-powered resume analysis and ATS optimization that gets you past the bots and in front of hiring managers.
                    </p>
            ...
            <div style={{
                ...
                <div className="form-card" style={{ width: "100%", maxWidth: 420 }}>
                    ...
                    <div style={{ background: "#0e0e1a", borderRadius: 20, border: "1px solid rgba(255,255,255,0.07)", padding: 28, boxShadow: "0 24px 64px rgba(0,0,0,0.4)" }}>
